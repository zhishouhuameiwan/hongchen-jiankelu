...
export const enemies: EnemyDefinition[] = [
  ...
  { id: 'ch1_black_market_boss', name: '黑市小头目', maxHp: 55, attack: 9, defense: 3, intents: [{ type: 'attack', amount: 9 }, { type: 'guard', amount: 7 }, { type: 'apply_status', status: 'vulnerable', amount: 1 }], rewardCardPool: ['blood_river_strike'], rewardSilver: 22 },
